...
function onEvent(name, value1, value2)
	if name == 'ZoomCamera' then
		...
		tweenCameraZoom((splitV1[1] == nil and DEFAULT_ZOOM or splitV1[1]), (splitV1[2] == nil and DEFAULT_DURATION or splitV1[2] / 2), false, (splitV1[3] == nil and DEFAULT_EASE or splitV1[3]), coiso);
	end
end